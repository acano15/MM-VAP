...
AUDIO_DIR = os.path.abspath(os.path.join(file_path, "..", "..", "..", "..", "noxi"))
#MULTIMODAL_DIR = "/ahc/work2/kazuyo-oni/projects/data/noxi"
MULTIMODAL_DIR = os.path.abspath(os.path.join(file_path, "..", "..", "..", "..", "noxi"))
...
def load_noxi(
    ...
    print(f"Genearting dataset for {split} type")
