...
#----------------------------------------------------------------------------
# Created By: @hhj1897
# url = 'https://github.com/hhj1897/face_detection/blob/master/ibug/face_detection/utils/data/bfm_lms.npy'
# ---------------------------------------------------------------------------
"""
...
MEAN_SHAPE_PATH = "bfm_lms.npy"


class HeadPoseEstimator(object):
    def __init__(self) -> None:
        # Load the 68-point mean shape derived from BFM
        mean_shape = np.load(os.path.join(file_path, MEAN_SHAPE_PATH))
